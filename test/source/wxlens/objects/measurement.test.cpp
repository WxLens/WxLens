...
TEST_F(MeasurementTest, DistanceProducesDistanceAndBearing)
{
   measurement_.setMode(static_cast<int>(Mode::Distance));
   measurement_.addPoint(35.0, -97.0, Pane(0));
...
TEST_F(MeasurementTest, DistanceStopsAtTwoVertices)
{
   measurement_.setMode(static_cast<int>(Mode::Distance));
   measurement_.addPoint(35.0, -97.0, Pane(0));
   measurement_.addPoint(36.0, -97.0, Pane(0));
...
TEST_F(MeasurementTest, RadarSnappedOriginUsesRadarNativeReadout)
{
   measurement_.setMode(static_cast<int>(Mode::Distance));
   measurement_.addPoint(Pane(0)->homeLatitude(), Pane(0)->homeLongitude(), Pane(0),
                         QStringLiteral("radar"), QStringLiteral("KTLX"));
   measurement_.addPoint(35.0, -97.0, Pane(0));
   ...
   EXPECT_TRUE(measurement_.readout().startsWith(QStringLiteral("Range")));
}
