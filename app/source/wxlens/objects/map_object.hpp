...
struct MapObject
{
   ...
   /// Saved-place taxonomy. Empty for ordinary analysis objects. A non-empty override wins over
   /// the group's colour; otherwise SavedPlaceManager supplies the inherited group colour.
   QString savedPlaceGroupId {};
