...
namespace
{
const QString kBuiltInDark  = QStringLiteral(":/qt/qml/Nimbus/App/res/themes/operational-dark.toml");
const QString kBuiltInLight = QStringLiteral(":/qt/qml/Nimbus/App/res/themes/daylight.toml");
const auto logger_ = nimbus::log::Create("theme.theme_manager");
