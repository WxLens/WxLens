 ...
 *
 * Deliberately does **not** use nimbus::log/spdlog: the fault this was built for happens during
 ...
 * equivalent would use backtrace()/backtrace_symbols() and belongs here if/when Nimbus actually
 * builds there.
 */
